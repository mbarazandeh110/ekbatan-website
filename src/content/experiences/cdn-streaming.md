...
highlights:
  ...
  - "طراحی معماری Failure-aware برای CDN و پیاده‌سازی Content-aware Traffic Steering با Load Balancer اختصاصی مبتنی بر Go در لایه ۷، با تصمیم‌گیری پویا بر اساس سلامت و بار CDN Nodeها، وضعیت Cache، محتوای درخواست و موقعیت شبکه‌ای کاربر."
