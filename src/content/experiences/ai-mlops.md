...
description: "استقرار و بهینه‌سازی مدل‌های هوش مصنوعی و LLM بر بستر کلاسترهای شتاب‌دهنده GPU، با بهره‌گیری از interconnectهای پرسرعتی مانند NVLink برای ارتباط بهینه بین GPUها و شبکه‌های پرظرفیت مانند RoCE برای ارتباط بین نودها، با هدف بهبود Performance، افزایش Throughput و کاهش Latency در فرآیندهای Training و Inference."
highlights:
  ...
  - "همگام‌سازی فوق‌سریع مموری با پل‌های ارتباطی 4-way NVLink (مدل S4A91C) و شبکه‌های RoCE"
