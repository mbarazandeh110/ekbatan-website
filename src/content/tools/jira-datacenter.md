...
architectureDetails:
  ...
  - "اتصال به دیتابیس PostgreSQL (مدیریت شده توسط Patroni/Cloudnative-pg) خارج از کلاستر جهت تفکیک Failure Domain"
...
features:
  ...
  - "رصدپذیری کامل (JMX Metrics) از طریق VictoriaMetrics و اتصال به داشبوردهای SRE"
  ...
  spec:
    ...
    template:
      spec:
        ...
        containers:
        - name: jira
          image: atlassian/jira-software:10.7.3 # Pinned & Validated Version
          resources:
            requests:
              memory: "8Gi"
              cpu: "4"
